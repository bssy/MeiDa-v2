...
public class LogUtil {
	...
	private static String LOG_PATH_SDCARD_DIR = "/mnt/sdcard/SoulSchool/"; // 日志文件在sdcard中的路径
...
//		Context context;
//		StorageManager sm = SchoolApplication.getContext().getSystemService(STORAGE_SERVICE);
		Date nowtime = new Date();
		String needWriteFiel = logfile.format(nowtime);
		String needWriteMessage = LogSdf.format(nowtime) + " " + mylogtype
				+ " " + tag + " " + text;

		File destDir = new File(LOG_PATH_SDCARD_DIR);
		  if (!destDir.exists()) {
		   destDir.mkdirs(); 
		  }
